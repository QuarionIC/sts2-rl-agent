...
#### `sts2_env.cards.defect` (26)

```text
HELIX_DRILL, HYPERBEAM,
IGNITION, ITERATION_CARD,
METEOR_STRIKE, MODDED, MULTI_CAST,
NULL_CARD, QUADCAST, RAINBOW, REBOOT, ROCKET_PUNCH,
SCRAPE, SHADOW_SHIELD, SHATTER, SIGNAL_BOOST, SMOKESTACK, SPINNER_CARD,
SUBROUTINE, SUPERCRITICAL,
SYNCHRONIZE, SYNTHESIS, TEMPEST, TESLA_COIL, TRASH_TO_TREASURE,
VOLTAIC
```
