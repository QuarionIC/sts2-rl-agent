...
#### `sts2_env.cards.defect` (41)

```text
BUFFER_CARD,
CAPACITOR, CONSUMING_SHADOW,
DARKNESS_CARD, DEFEND_DEFECT,
ECHO_FORM_CARD,
GENETIC_ALGORITHM,
HAILSTORM, HELIX_DRILL, HYPERBEAM,
IGNITION, ITERATION_CARD,
MACHINE_LEARNING_CARD, METEOR_STRIKE, MODDED, MULTI_CAST,
NULL_CARD, OVERCLOCK, QUADCAST, RAINBOW, REBOOT, ROCKET_PUNCH,
SCRAPE, SHADOW_SHIELD, SHATTER, SIGNAL_BOOST, SKIM, SMOKESTACK, SPINNER_CARD,
STORM_CARD, STRIKE_DEFECT, SUBROUTINE, SUPERCRITICAL,
