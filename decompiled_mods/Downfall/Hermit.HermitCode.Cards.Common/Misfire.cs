...
public sealed class Misfire : HermitCardModel
{
		...
		: base(1, (CardType)1, (CardRarity)2, (TargetType)2)
	{
		...
		((ConstructedCardModel)(object)this).WithTip<Clumsy>();
	}
	...
	protected override async Task OnPlayInternal(PlayerChoiceContext ctx, CardPlay play)
	{
		...
		await CommonActions.CardAttack((CardModel)(object)this, play, 1, (string)null, (string)null, (string)null).WithHermitGunHitFx().BeforeDamage((Func<Task>)delegate
		{
			...
			.Execute(ctx);
		await DownfallCardCmd.GiveCard<Clumsy>(((CardModel)this).Owner, (PileType)1, (CardPilePosition)3, upgraded: false, 0.6f, (CardPreviewStyle)1, skipAnimation: false, (Action<Clumsy>?)null, (Player?)null);
	}
}
