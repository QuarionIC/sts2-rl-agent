...
public class HotStreak : HexaghostCardModel
{
	...
	{
		((ConstructedCardModel)(object)this).WithPower<HotStreakPower>(6, 2, showTooltip: false);
		((ConstructedCardModel)(object)this).WithTip<SoulBurnPower>();
	}

	protected override async Task OnPlayInternal(PlayerChoiceContext ctx, CardPlay cardPlay)
	{
		await CommonActions.ApplySelf<HotStreakPower>(ctx, (CardModel)(object)this, false);
	}
}
