...
[GlobalClass]
[ScriptPath("res://GuardianCode/Vfx/NGuardianCreatureVisuals.cs")]
public class NGuardianCreatureVisuals : NCreatureVisuals, IAnimatedVisuals
{
	...
	{
		public static readonly StringName IsDefensive = StringName.op_Implicit("IsDefensive");
	...
	{
		if ((ref name) == PropertyName.IsDefensive)
		{
			IsDefensive = VariantUtils.ConvertTo<bool>(ref value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if ((ref name) == PropertyName.IsDefensive)
		{
			bool isDefensive = IsDefensive;
			value = VariantUtils.CreateFrom<bool>(ref isDefensive);
			return true;
		}
	...
	internal static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		{
			new PropertyInfo((Type)1, PropertyName.IsDefensive, (PropertyHint)0, "", (PropertyUsageFlags)4096, false),
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		StringName isDefensive = PropertyName.IsDefensive;
		bool isDefensive2 = IsDefensive;
		info.AddProperty(isDefensive, Variant.From<bool>(ref isDefensive2));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName.IsDefensive, ref val))
		{
			IsDefensive = ((Variant)(ref val)).As<bool>();
		}
	}
}
