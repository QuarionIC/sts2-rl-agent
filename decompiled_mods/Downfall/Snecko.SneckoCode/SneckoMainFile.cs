...
[ScriptPath("res://SneckoCode/SneckoMainFile.cs")]
public class SneckoMainFile : Node
{
	...
	public const string ModId = "Snecko";

	public static Logger Logger { get; } = new Logger("Snecko", (LogType)0);

	public static void Initialize()
	{
		CardExecutionRegistry.RegisterAfter(SneckoCardEffectHandler.DoAfterOnPlayInternal);
		BundledSubmodLocRegistry.Register("Snecko");
	}
