...
[GlobalClass]
[ScriptPath("res://AwakenedCode/Vfx/NAwakenedCreatureVisuals.cs")]
public class NAwakenedCreatureVisuals : NCreatureVisuals, IAnimatedVisuals
{
	...
	{
		public static readonly StringName IsAwakened = StringName.op_Implicit("IsAwakened");
	...
	{
		if ((ref name) == PropertyName.IsAwakened)
		{
			IsAwakened = VariantUtils.ConvertTo<bool>(ref value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if ((ref name) == PropertyName.IsAwakened)
		{
			bool isAwakened = IsAwakened;
			value = VariantUtils.CreateFrom<bool>(ref isAwakened);
			return true;
		}
	...
	internal static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		{
			new PropertyInfo((Type)1, PropertyName.IsAwakened, (PropertyHint)0, "", (PropertyUsageFlags)4096, false),
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		StringName isAwakened = PropertyName.IsAwakened;
		bool isAwakened2 = IsAwakened;
		info.AddProperty(isAwakened, Variant.From<bool>(ref isAwakened2));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName.IsAwakened, ref val))
		{
			IsAwakened = ((Variant)(ref val)).As<bool>();
		}
	}
}
