...
[ScriptPath("res://AutomatonCode/AutomatonMainFile.cs")]
public class AutomatonMainFile : Node
{
	...
	public static Logger Logger { get; } = new Logger("Automaton", (LogType)0);
	...
	public static void Initialize()
	{
		...
		CardDescriptionRegistry.Register<AutomatonCardModel>(DescriptionInjectionPoint.AboveMainText, (IExtraDescriptionSource)new EncodeDescriptionSource());
		BundledSubmodLocRegistry.Register("Automaton");
	}
