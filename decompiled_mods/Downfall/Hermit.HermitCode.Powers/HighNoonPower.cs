...
public sealed class HighNoonPower : HermitPowerModel
{
	private bool IsMyBasicStrike(CardModel card)
	{
		...
		if (card.Owner.Creature == ((PowerModel)this).Owner && card.Tags.Contains((CardTag)1))
		{
	...
	public override Task AfterPowerAmountChanged(PlayerChoiceContext choiceContext, PowerModel power, decimal amount, Creature? applier, CardModel? cardSource)
	{
		...
		else
		{
			...
			obj = ((playerCombatState != null) ? playerCombatState.AllCards.Where(IsMyBasicStrike) : null);
		}
