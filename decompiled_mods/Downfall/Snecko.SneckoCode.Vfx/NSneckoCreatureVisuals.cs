...
[GlobalClass]
[ScriptPath("res://SneckoCode/Vfx/NSneckoCreatureVisuals.cs")]
public class NSneckoCreatureVisuals : NCreatureVisuals, IAnimatedVisuals
{
	...
	public void OnAnimationTrigger(string trigger)
	{
		...
		case "Idle":
			...
			break;
		case "Attack":
			_animState?.SetAnimationWithMix("Attack_2", 0.1f, loop: false);
		...
		case "Hit":
			...
			break;
		case "Cast":
			_animState?.SetAnimationWithMix("Attack", 0.1f, loop: false);
			_animState?.QueueAnimation("Idle", 0.35f);
			break;
		}
	}
