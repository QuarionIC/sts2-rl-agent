...
public class InsultingSlime : SlimeModel
{
	...
	public override IEnumerable<IHoverTip> ExtraTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromPower<VulnerablePower>((int?)null));
	...
	public override async Task Command(PlayerChoiceContext ctx)
	{
		...
		await PowerCmd.Apply<VulnerablePower>(ctx, enumerable, (decimal)num, ((MonsterModel)this).Creature, (CardModel)null, false);
	}
}
