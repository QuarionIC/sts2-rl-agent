...
public class GhostflameSlime : SlimeModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>((DynamicVar[])(object)new DynamicVar[2]
	{
		...
		new SlimeSecondaryVar(6m)
	});

	public override IEnumerable<IHoverTip> ExtraTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromPower<SoulBurnPower>((int?)null));
	...
	public override async Task Command(PlayerChoiceContext ctx)
	{
		...
		await PowerCmd.Apply<SoulBurnPower>(ctx, enumerable, (decimal)num, ((MonsterModel)this).Creature, (CardModel)null, false);
	}
}
