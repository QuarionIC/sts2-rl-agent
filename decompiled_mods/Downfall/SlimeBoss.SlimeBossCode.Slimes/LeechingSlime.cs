...
public class LeechingSlime : SlimeModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>((DynamicVar[])(object)new DynamicVar[2]
	{
		...
		new SlimeSecondaryVar(3m)
	});

	public override IEnumerable<IHoverTip> ExtraTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.Static((StaticHoverTip)5, Array.Empty<DynamicVar>()));
	...
	public override async Task Command(PlayerChoiceContext ctx)
	{
		...
		await CreatureCmd.GainBlock(base.PetOwner, (decimal)num, (ValueProp)8, (CardPlay)null, false);
	}
}
