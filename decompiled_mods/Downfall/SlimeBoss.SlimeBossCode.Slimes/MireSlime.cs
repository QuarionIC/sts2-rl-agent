...
public class MireSlime : SlimeModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>((DynamicVar[])(object)new DynamicVar[2]
	{
		...
		new SlimeSecondaryVar(2m)
	});

	public override IEnumerable<IHoverTip> ExtraTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromPower<GoopPower>((int?)null));
	...
	public override async Task Command(PlayerChoiceContext ctx)
	{
		...
		await PowerCmd.Apply<GoopPower>(ctx, enumerable, (decimal)num, base.PetOwner, (CardModel)null, false);
	}
}
