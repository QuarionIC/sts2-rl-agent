...
public class DefensiveFinisherVar : DynamicVar
{
	private ChampStanceModel Stance => (ChampStanceModel)(object)base._owner;

	public DefensiveFinisherVar(decimal baseAmount)
		: base("DefensiveFinisher", baseAmount)
	{
	}
	...
	public decimal Calculate()
	{
		...
		int num = ChampHook.ModifyDefensiveFinisherBonus(Stance.CombatState, Stance, (int)base._baseValue);
