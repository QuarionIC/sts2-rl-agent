...
public class DefensiveSkillVar : DynamicVar
{
	private ChampStanceModel Stance => (ChampStanceModel)(object)base._owner;

	public DefensiveSkillVar(decimal baseAmount)
		: base("DefensiveSkill", baseAmount)
	{
	}
	...
	public decimal Calculate()
	{
		...
		int num = ChampHook.ModifySkillBonus<CounterPower>(Stance.CombatState, Stance, (int)base._baseValue);
