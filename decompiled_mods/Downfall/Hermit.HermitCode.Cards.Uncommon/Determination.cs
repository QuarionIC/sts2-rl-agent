...
public sealed class Determination : HermitCardModel
{
		...
		: base(1, (CardType)3, (CardRarity)3, (TargetType)1)
	{
		...
		((ConstructedCardModel)(object)this).WithPower<DeterminationPower>(1, showTooltip: false);
	}
	...
	protected override async Task OnPlayInternal(PlayerChoiceContext ctx, CardPlay play)
	{
		...
		await CommonActions.ApplySelf<DeterminationPower>(ctx, (CardModel)(object)this, false);
	}
}
