...
public sealed class ShadowCloak : HermitCardModel
{
	...
	{
		((ConstructedCardModel)(object)this).WithPower<ShadowCloakPower>(4, 2, showTooltip: false);
	...
	protected override async Task OnPlayInternal(PlayerChoiceContext ctx, CardPlay play)
	{
		...
		await CommonActions.ApplySelf<ShadowCloakPower>(ctx, (CardModel)(object)this, false);
	}
}
