...
{
	public override IEnumerable<IHoverTip> ExtraHoverTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.Static(GuardianTip.Accelerate, Array.Empty<DynamicVar>()));
	...
	public override Color GemColor => new Color(3503358207u);
	...
	protected override async Task OnPlayInternal(PlayerChoiceContext ctx, CardPlay? cardPlay)
	{
		...
		await GuardianCmd.Accelerate(ctx, base.Player, (int)num);
	}
}
