...
public class LightFlareSEffect : NSts1Effect
{
	...
	{
		LightFlareSEffect lightFlareSEffect = new LightFlareSEffect();
		lightFlareSEffect._renderGreen = renderGreen;
		lightFlareSEffect.SetupAt(x, y);
		return lightFlareSEffect;
	}
