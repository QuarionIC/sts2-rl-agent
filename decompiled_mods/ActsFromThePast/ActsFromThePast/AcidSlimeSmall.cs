...
public sealed class AcidSlimeSmall : CustomMonsterModel
{
	...
	public override int MinInitialHp => AscensionHelper.GetValueIfAscension((AscensionLevel)8, 9, 8);

	public override int MaxInitialHp => AscensionHelper.GetValueIfAscension((AscensionLevel)8, 13, 12);

	private int TackleDamage => AscensionHelper.GetValueIfAscension((AscensionLevel)9, 4, 3);
	...
	{
		((MonsterModel)this).Creature.Died -= OnDeath;
		NAudioManager.Instance.PlayOneShot("event:/sfx/enemy/enemy_attacks/twig_slime_s/twig_slime_s_die", 1f);
	}
	...
	protected override MonsterMoveStateMachine GenerateMoveStateMachine()
	{
		...
		MoveState val2 = (MoveState)(object)(val.FollowUpState = (MonsterState)new MoveState("LICK", (Func<IReadOnlyList<Creature>, Task>)Lick, (AbstractIntent[])(object)new AbstractIntent[1] { (AbstractIntent)new DebuffIntent(false) }));
		val2.FollowUpState = (MonsterState)(object)val;
		list.Add((MonsterState)(object)val);
		list.Add((MonsterState)(object)val2);
		return new MonsterMoveStateMachine((IEnumerable<MonsterState>)list, (MonsterState)(object)val2);
	}
