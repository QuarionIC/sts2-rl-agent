...
public sealed class ByrdAndChosenNormal : CustomEncounterModel
{
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters
	{
		get
		{
			yield return (MonsterModel)(object)ModelDb.Monster<Byrd>();
	...
	protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
	{
		...
		{
			(((MonsterModel)ModelDb.Monster<Byrd>()).ToMutable(), null),
			(((MonsterModel)ModelDb.Monster<Chosen>()).ToMutable(), null)
		};
	}
}
