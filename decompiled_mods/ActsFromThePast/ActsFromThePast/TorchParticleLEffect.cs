...
public class TorchParticleLEffect : NSts1Effect
{
	...
	{
		TorchParticleLEffect torchParticleLEffect = new TorchParticleLEffect();
		torchParticleLEffect._renderGreen = renderGreen;
		torchParticleLEffect.SetupAt(x, y);
		return torchParticleLEffect;
	}
