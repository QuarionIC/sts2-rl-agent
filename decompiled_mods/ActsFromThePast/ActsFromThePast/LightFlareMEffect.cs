...
public class LightFlareMEffect : NSts1Effect
{
	...
	{
		LightFlareMEffect lightFlareMEffect = new LightFlareMEffect();
		lightFlareMEffect._renderGreen = renderGreen;
		lightFlareMEffect.SetupAt(x, y);
		return lightFlareMEffect;
	}
	...
	private void SetupAt(float x, float y)
	{
		...
		_scale = (float)GD.RandRange(4.0, 5.0);
